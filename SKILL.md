...
version: 1.0.0
author: Galaxy Maps
repository: https://github.com/Galaxy-Maps/gm-agent-03-curriculum
standalone: true
model: ultra
inputs:
  - INTENT.md
...
| Tool | Purpose |
|------|---------|
| `Read` | Read INTENT.md (and previous MAP_V{n}.md / SUGGESTIONS.md on regeneration) |
| `Write` | Write `alternatives.md` (uncommitted) and the selected `MAP_V{n}.md` |
| `Bash` | `git add MAP_V{n}.md && git commit` |
| `AskUserQuestion` | Present the 3 alternatives for selection |
